...
static const struct myoption opts[] = 
  ...
  { 
	...
	{ "nxdomain-as-refused", 0, 0 , LOPT_NXD_AS_REFUSE },
    { NULL, 0, 0, 0 }
  };
...
static struct {
  ...
  { LOPT_NXD_AS_REFUSE, OPT_NXD_AS_REFUSED, NULL, gettext_noop("Treat all NXDOMAIN answers from upstream DNS servers as REFUSED."), NULL }, 
  { 0, 0, NULL, NULL, NULL }
}; 
